...
func (s *KeysService) Get(ctx context.Context, id string) (*KeyDetail, error) {
	var out KeyDetail
	if err := s.http.get(ctx, fmt.Sprintf("/v1/keys/%s", pathSegment(id)), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (s *KeysService) Rotate(ctx context.Context, id string) (*Key, error) {
	var out Key
	if err := s.http.post(ctx, fmt.Sprintf("/v1/keys/%s/rotate", pathSegment(id)), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (s *KeysService) Disable(ctx context.Context, id string) error {
	return s.http.delete(ctx, fmt.Sprintf("/v1/keys/%s", pathSegment(id)))
}
...
func (s *KeysService) Export(ctx context.Context, id string) (*KeyExportResponse, error) {
	...
	if err := s.http.post(ctx, fmt.Sprintf("/v1/keys/%s/export", pathSegment(id)), nil, &out); err != nil {
		return nil, err
	}
	return &out, nil
}
...
func (s *KeysService) SetRotationPolicy(ctx context.Context, id string, intervalDays *int) error {
	...
	return s.http.patch(ctx, "/v1/keys/"+pathSegment(id)+"/rotation", body, nil)
}
